...
export default function PfNotificationPanel({ onClose, items, loading }) {
  ...
  return (
    <motion.div
      key="pf-notif-layer"
      className="fixed inset-0 z-[78] flex justify-end"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      ...
      <motion.aside
        ...
        className="relative z-[1] flex h-full w-full max-w-md flex-col border-l border-[var(--pf-border)] bg-[var(--pf-bg)] shadow-[-12px_0_40px_rgba(0,0,0,0.12)] dark:shadow-[-12px_0_40px_rgba(0,0,0,0.45)]"
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 py-3">
          {loading ? (
            ...
            <p className="px-2 py-12 text-center text-sm text-[var(--pf-text-muted)]">
